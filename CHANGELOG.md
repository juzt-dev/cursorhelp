...
**Note:** Historical entries below reference the original repository URLs for commit history accuracy. All new development occurs in the juzt-dev/cursorhelp repository.
