...
## Your mission
Use the `planner` agent to create 2 detailed implementation plans for this following task:
<task>
 $ARGUMENTS
</task>
...
5. Main agent gathers all research and scout report filepaths, and pass them to `planner` agent with the detailed instructions prompt to create an implementation plan of this task.
...
1. Main agent receives the implementation plan from `planner` agent, and ask user to review the plan
