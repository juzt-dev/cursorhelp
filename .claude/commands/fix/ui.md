...
Use `ui-ux-designer` agent to read and analyze `./docs/design-guidelines.md` then fix the following issues:
...
1. Use `ui-ux-designer` agent to implement the fix step by step.
