...
## Workflow:
1. Use `researcher` agent to research about design style, trends, fonts, colors, border, spacing, elements' positions, etc.
2. Use `ui-ux-designer` agent to implement the design step by step based on the research.
