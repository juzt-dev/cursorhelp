...
2. Use `ui-ux-designer` agent to create a design implementation plan following the progressive disclosure structure so the result matches the screenshot/video:
