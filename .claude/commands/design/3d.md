...
## Workflow:
1. Use `ui-ux-designer` agent and `researcher` agent to create a comprehensive 3D design plan following the progressive disclosure structure:
...
2. Then use `ui-ux-designer` agent to implement the plan step by step.
